 ...
 * Manage pop up
 * Created by sstto on 28-11-2017.
 */
...
public class MainActivity extends AppCompatActivity {
    ...
    private void appinfoDialog(){
        ...
        infopage.setText("Difficulty in locating a victim in disaster? No clue where to go, whom to contact during times of disaster?\n"
                + "With the help of SOS app, you can protect yourself and send message for help in just a click.\n" +
                "Halifax SOS app is your personal safety in times of any unfortunate events like a fire or earthquake. The application is simple and efficient in finding help if you are in danger. The app functionalities include the following:\n" +
                "Send SMS and make call to emergency contact\n" +
                "Auto-enable flashlight and Bluetooth for easy discovery\n" +
                "\n" +
                "Click settings to personalize your app with desired contact details");
        dialog.show();
